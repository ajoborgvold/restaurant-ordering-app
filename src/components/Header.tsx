...
export default function Header(): JSX.Element {
  ...
  return (
    <header className="flex items-center gap-2 bg-gradient-to-r from-amber-900 to-amber-500 dark:from-slate-800 dark:to-slate-500 py-6 sm:py-8 md:py-10 px-4 sm:px-12 md:px-24">
      <div>
        <h1 className="text-amber-100 dark:text-slate-100 text-3xl sm:text-5xl md:text-6xl">
          Ajo's Diner
        </h1>
        <p className="text-amber-100 dark:text-slate-100 text-lg sm:text-xl md:text-2xl">
