...
export default function Header(): JSX.Element {
  ...
  return (
    <header className="flex items-center gap-2 bg-gradient-to-r from-amber-900 dark:from-slate-400 to-amber-500 dark:to-slate-500 py-10 px-4 sm:px-12 md:px-24">
      <div>
